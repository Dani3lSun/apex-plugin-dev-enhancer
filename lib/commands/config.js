...
module.exports = function(args) {
  ...
  var schema = {
    properties: {
      ...
      dbSid: {
        description: chalk.blue.bold('Enter DB SID'),
        type: 'string',
        required: false
      },
      dbServicename: {
        description: chalk.blue.bold('Enter DB service name'),
        type: 'string',
        required: false
      },
      dbUsername: {
      ...
      addPackageCodeToDist: {
        description: chalk.blue.bold('Should the PL/SQL package code be concatenated to plugin export file for easier distribution? [Y/N]'),
        type: 'string',
        required: true
      },
      srcApexFolder: {
  ...
  prompt.get(schema, function(err, result) {
    if (result) {
      ...
      apdeConfigJson.plugin.addPackageCodeToDist = result.addPackageCodeToDist;
      ...
      if (result.dbServicename) {
        apdeConfigJson.database.servicename = result.dbServicename;
      }
